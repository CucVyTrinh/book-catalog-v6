    ...
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <main style={{ flex: 1, padding: "30px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "250px 1fr", gap: "12px" }}>
          {/* Left column: Add / Update / Delete buttons */}
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <button onClick={handleUpdate} style={{ padding: "10px" }}>Update</button>
            <button onClick={handleDelete} style={{ padding: "10px" }}>Delete</button>
          </div>
